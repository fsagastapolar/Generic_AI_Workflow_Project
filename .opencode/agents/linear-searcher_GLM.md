...
### Get team info (discover team key/name and states)
...
1. **Fetch by ID** — Get full details of a specific ticket
...
5. **Context gathering** — Search by relevant keywords and return matches
