---
description: Decides which testing guides are needed based on implementation type (API, frontend, full-stack, infra) and orchestrates their creation by delegating to the appropriate specialist agents. Give it a summary of what was implemented and it handles the rest.
...
Use the Task tool with subagent_type `e2e-test-guide-creator`.
...
Create a manual test guide at `thoughts/shared/testing/YYYY-MM-DD-[feature]-manual-test-guide.md`.
...
### API E2E Test Guide
- Path: [path]
- Covers: [endpoints/scenarios]

### Frontend E2E Test Guide
- Path: [path]
- Ready for: [angular-tester / react-tester / vue-tester]

### Manual Test Guide
- Path: [path]
- Covers: [manual scenarios]
...
- **Delegate, don't duplicate** — use e2e-test-guide-creator for API guides
