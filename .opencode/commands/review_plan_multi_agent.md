---
description: Multi-agent plan review — runs 2-3 independent reviewers (Claude, Gemini, Codex) in parallel, then consolidates and dedupes their findings with attribution. GH-only because GLM cannot access multiple model providers.
agent: build
