...
- **Environment**: Follow execution environment rules from project guidelines
...
- If the plan includes **frontend modifications**, include a step to create a frontend E2E testing guide (after implementation) for the appropriate tester agent
